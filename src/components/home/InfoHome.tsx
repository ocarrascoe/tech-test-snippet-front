  ...
  <React.Fragment>
    <CardContent style={{paddingLeft: 40, paddingRight: 40}}>
      ...
      <Typography variant="body1" component="div">
        ...
        href="https://www.udemy.com/course/nextjs-fh/" target="_blank" rel="noreferrer">curso de NextJS</a> que estoy
        realizando, si bien este proyecto no está construido con NextJS, al ser un framework de React es bastante fácil
        de adaptar lo aprendido. Todo está realizado con Typescript aunque no hay problema en trabajar en JavaScript si
        es necesario.
      </Typography>
      <br/>
      <Typography variant="body1" component="div">
        Cabe destacar que sé hacer uso de memo, useMemo y useCallback, contextos (en específico cree un contexto para la
        UI y finalmente no lo utilice) e incluso el uso de redux (normalmente hago uso del patrón "ducks" para esto
